...
describe('Transaction', function () {
  ...
  describe('fromhex/updateidentityrawtransaction', function () { 
    ...
    var unfundedTxObj = Transaction.fromHex(data, NETWORKS.verustest);
    var {unpackOutput } = require('../src/smart_transactions')
    const system = "iJhCezBExJHvtyH3fGhNnt2NhU4Ztkf2yq"
   // const outputInfo = unpackOutput(unfundedTxObj.outs[0], system); //This wont work as it doesnt support identity outputs evalcode 14 TODO: update
